...
def true_sky_table(raw_obs: pd.DataFrame, a90_deg2: float = TRUE_SKY_A90_DEG2) -> pd.DataFrame:
    """Build an oracle ET3 sky table from true ra/dec.

    This is an upper-bound ablation. It bypasses observed-sky center sampling
    and should be reported separately from deployable observed-sky results.
    """
