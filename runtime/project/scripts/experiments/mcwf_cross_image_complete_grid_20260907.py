...
import mcwf_cross_image_population_evaluate_20260907 as rnc
...
def run(root, model, arm):
    code = 'CROSS-IMAGE-RNC-COMPLETE-GRID-MASS-COSINE'
    ...
    dev.json_write(trial / 'contracts/RECIPE.json', {
        ...
        'formula': 'Z_FRT+gamma*newRNCfiniteMctail+beta*boundednewRNCcosineLR;identical to CROSS-IMAGE-POPULATION-RNC-MASS-COSINE',
...
if __name__ == '__main__':
    ...
    run(args.root, 'cross_image_RNC', 'MASS-COSINE')
