...
OUT_ROOT = Path('runs/waveform_feature_skymap_predictor_20260604')
SOURCE_ROOT = Path('runs/unified_sky_aux_comparison_20260603')
JOBS = [j for j in base.JOBS if j['mode'] == 'noisy']
PREDICTORS = ['waveform_stats_ridge', 'fusion_stats_embedding_ridge', 'fusion_stats_embedding_mlp']
N_BINS = 256
NEG_PER_POS = 500
CHUNK_ROWS = 64
