...
OUT_ROOT = Path('runs/ligo_sis_expected_angular_grid18_skymap_rerank_20260605')
...
def run_job(job):
    ...
    row = {
        ...
        'method': 'ligo_sis_expected_angular_grid18_skymap_rerank',
        'features': 'log1p_delta_time_obs,expected_angular_grid18_skymap_overlap,waveform_score,waveform_reciprocal_rank',
        'sky_model': f'SkyMapCNN_expected_angular_grid_{DEC_BINS}x{RA_BINS}',
