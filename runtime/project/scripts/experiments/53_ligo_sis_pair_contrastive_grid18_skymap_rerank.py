...
OUT_ROOT = Path('runs/ligo_sis_pair_contrastive_grid18_skymap_rerank_20260605')
...
def run_job(job):
    ...
    row = {
        ...
        'method': 'ligo_sis_pair_contrastive_grid18_skymap_rerank',
        'features': 'log1p_delta_time_obs,pair_contrastive_grid18_skymap_overlap,waveform_score,waveform_reciprocal_rank',
        'sky_model': f'SkyMapCNN_pair_contrastive_grid_{DEC_BINS}x{RA_BINS}',
