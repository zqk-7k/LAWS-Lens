...
import mcwf_large_population_hard_evaluate_20260907 as rnc
...
def run(root, model, arm):
    code = 'HARD-BATCH-RNC-COMPLETE-GRID-MASS-COSINE'
    ...
    dev.json_write(trial / 'contracts/RECIPE.json', {
        ...
        'formula': 'Z_FRT+gamma*newRNCfiniteMctail+beta*boundednewRNCcosineLR;identical to LARGE-POPULATION-HARD-BATCH-MASS-COSINE',
...
if __name__ == '__main__':
    ...
    run(args.root, 'large_RNC', 'MASS-COSINE')
