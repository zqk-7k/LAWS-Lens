...
if __name__ == '__main__':
    ...
    g.ROOT = args.root
    source, data, v3 = g.expanded.modules()
    # The historical loader constructs fresh module objects on every call.
    g.expanded.modules = lambda: (source, data, v3)
    ...
    record = g.ROOT/'contracts/READ_CACHE_RUNTIME_V2_ADDENDUM.json'
    if not record.exists():
        ...
        shutil.copy2(__file__, g.ROOT/'scripts/independent_development_runtime_v2.py')
    for dep in g.n.DEPS:
