...
EXTRA = [
    ...
    (48, 'mcwf_nodup_quality_rejection_48_20260909T155053Z',
     'Only lower R35 when the existing profile true-source tail is below0.05;no new threshold search'),
    (49, 'mcwf_nodup_paired_quality_backoff_49_20260909T160024Z',
     'R48 only when both profiles are valid;otherwise exactly preserve NODUP waveform score'),
]
