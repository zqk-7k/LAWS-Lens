...
def freeze():
    ...
    n.write_json(ROOT/'contracts/ANALYSIS_CONTRACT.json',{'UTC':n.utc(),
        ...
        'unit_implementation':'Cast the stored float32 conditioned series to float64 before multiplying by3. The original test introduced float32 rounding and failed a1e-10 tolerance by4.1e-9; original failure retained separately. Statistic and tolerance unchanged.',
