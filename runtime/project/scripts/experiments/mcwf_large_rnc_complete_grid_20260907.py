...
def run(root, model, arm):
    code = 'LARGE-RNC-COMPLETE-GRID-MASS-COSINE'
    ...
    dev.json_write(trial / 'contracts/RECIPE.json', {
        ...
        'formula': 'Z_FRT+gamma*newRNCfiniteMctail+beta*boundednewRNCcosineLR;identical to LARGE-POPULATION-RNC-MASS-COSINE',
